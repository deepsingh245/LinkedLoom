            ...
            <Card className="w-full max-w-md">
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                         <Button variant="outline" type="button" onClick={loginWithGoogle} disabled={loading}>
                        ...
                        <Button variant="outline" type="button" onClick={loginWithLinkedin} disabled={loading}>
                ...
                <CardFooter className="flex justify-center border-t p-4 mt-4">
                    <div className="text-sm text-muted-foreground">
                        Already have an account? <Link href={Routes.LOGIN} className="underline hover:text-primary">Login</Link>
                    </div>
                </CardFooter>
            </Card>
        </div>
