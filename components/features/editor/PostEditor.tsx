                    ...
                    <Card className="animate-fadeUp animation-delay-100 p-5 rounded-2xl border border-border bg-card shadow-sm transition-all hover:border-accent">
                        ...
                        <div className="mb-4">
                            <button
                                ...
                                className="flex items-center justify-between w-full text-[12.5px] font-semibold text-muted-foreground hover:text-foreground transition-colors py-1"
                            >
                            ...
                            {showAdvanced && (
                                <div className="mt-3 space-y-3.5 p-3.5 rounded-xl bg-accent/20 border border-border/50 animate-in fade-in duration-200">
                        ...
                        <div>
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button disabled={saving} className="w-full h-11 justify-start text-left font-normal bg-background border border-border text-foreground text-[13.5px] rounded-[10px] hover:bg-accent hover:border-border/80">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full flex-1">
                                ...
                                <div className="flex flex-col h-full">
                                    ...
                                    <div className="flex justify-between items-center text-[11px] font-medium">
                                        <span className="text-muted-foreground">{content.length}/{LINKEDIN_MAX_LENGTH} chars</span>
